...
public class DeleteAcademicYearConfirmAction extends ActionBase {
	...
	protected void setSessionVars() {
		if(actionResponse.isSuccess()) {
			...
			pagination.updateList((AcademicYearDTO) getSessionAttribute(AcademicYearDTO.SESSION_ACADEMIC_YEAR), DAOBase.DAO_ACTION_DELETE);
	...
	protected void executeLogic() {
		execute(AcademicYearDTO.SESSION_ACADEMIC_YEAR, new AcademicYearDAO(), DAOBase.DAO_ACTION_DELETE);
	}
}