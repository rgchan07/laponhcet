...
public class DeleteFeeConfirmAction extends ActionBase {
	...
	protected void setSessionVars() {
		if(actionResponse.isSuccess()) {
			...
			pagination.updateList((FeeDTO) getSessionAttribute(FeeDTO.SESSION_FEE), DAOBase.DAO_ACTION_DELETE);
	...
	protected void executeLogic() {
		execute(FeeDTO.SESSION_FEE, new FeeDAO(), DAOBase.DAO_ACTION_DELETE);
	}
}
