...
public class UpdateSemesterConfirmAction extends ActionBase {
	...
	protected void setSessionVars() {
		if(actionResponse.isSuccess()) {
			...
			pagination.updateList((SemesterDTO) getSessionAttribute(SemesterDTO.SESSION_SEMESTER), DAOBase.DAO_ACTION_UPDATE);
	...
	protected void executeLogic() {
		execute(SemesterDTO.SESSION_SEMESTER, new SemesterDAO(), DAOBase.DAO_ACTION_UPDATE);
	}
}
