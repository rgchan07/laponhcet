...
public class UpdateVenueConfirmAction extends ActionBase {
	...
	protected void setSessionVars() {
		if(actionResponse.isSuccess()) {
			...
			pagination.updateList((VenueDTO) getSessionAttribute(VenueDTO.SESSION_VENUE), DAOBase.DAO_ACTION_UPDATE);
	...
	protected void executeLogic() {
		execute(VenueDTO.SESSION_VENUE, new VenueDAO(), DAOBase.DAO_ACTION_UPDATE);
	}
}
