...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(TeacherDTO.SESSION_TEACHER_PAGINATION);
	TeacherDTO teacherSelected = (TeacherDTO) session.getAttribute(TeacherDTO.SESSION_TEACHER);
%>
