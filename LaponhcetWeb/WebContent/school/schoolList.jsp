...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(SchoolDTO.SESSION_SCHOOL_PAGINATION);
%>
<div class="ibox float-e-margins">
	<div class="ibox-content">
     	<div class="row">
			...
			<%=new ComboBoxWebControl().getComboBoxWebControl(null, "col-sm-4", false, "Search Criteria", "SearchCriteria",  SchoolDTO.PAGINATION_SEARCH_CRITERIA_LIST, "Name", SchoolDTO.PAGINATION_SEARCH_CRITERIA_LIST, "", "", "")%>
