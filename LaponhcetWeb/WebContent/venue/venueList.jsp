...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(VenueDTO.SESSION_VENUE_PAGINATION);
%>
    ...
    <div class="ibox float-e-margins">
    	<div class="ibox-content">
         	<div class="row">
				...
				<%=new ComboBoxWebControl().getComboBoxWebControl(null, "col-sm-4", false, "Search Criteria", "SearchCriteria", new String[] {"Code", "Name"}, "Name", VenueDTO.SEARCHCRITERIA, "", "", "")%>
