...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(AcademicProgramDTO.SESSION_ACADEMIC_PROGRAM_PAGINATION);
%>
<div class="ibox float-e-margins">
	<div class="ibox-content">
     	<div class="row">
			...
			<%=new ComboBoxWebControl().getComboBoxWebControl(null, "col-sm-4", false, "Search Criteria", "SearchCriteria",  AcademicProgramDTO.PAGINATION_SEARCH_CRITERIA_LIST, AcademicProgramDTO.PAGINATION_SEARCH_CRITERIA_LIST[0], AcademicProgramDTO.PAGINATION_SEARCH_CRITERIA_LIST, "", "", "")%>
