...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(SupplierDTO.SESSION_SUPPLIER_PAGINATION);
%>
    ...
    <div class="ibox float-e-margins">
    	<div class="ibox-content">
         	<div class="row">
				...
				<%=new ComboBoxWebControl().getComboBoxWebControl(null, "col-sm-4", false, "Search Criteria", "SearchCriteria", new String[] {"Code", "Name"}, "Name", SupplierDTO.SEARCHCRITERIA, "", "", "")%>
